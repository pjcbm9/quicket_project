...
public class DBAdapter {
    ...
    public void updateTicket(Ticket ticket) {
        db.execSQL("UPDATE mainTable2 SET ticketname='"+ ticket.getTicketName()
                ...
                + "',ticketstatus='" + ticket.getStatus().toString() + "',ticketcountdown='" + ticket.getCountDownDuration()
                + "',ticketcountdown='" + ticket.getCountDownDuration() + "' WHERE ticketid='" + ticket.getID() + "'");
    }
